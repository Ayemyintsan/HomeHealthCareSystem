...
<body>
    <div class="wrapper">
        ...
        <div class="main_content">
            <div class="header">Add More Supervisor</div>
            <div class="info">
                <div>
                    <form:form action="saveSupervisor" modelAttribute="supervisor" method="post">
                        

                        <div class="input-group">
                            <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                            <form:input id="name" type="text" class="form-control" path="name" pattern="^[A-Za-z\s]+$" 
                            maxlength="49" placeholder=" Name"/>
                        </div>
                        <Br>
                        ...
                        <div class="input-group">
                            ...
                            <form:input id="phone" type="text" class="form-control" path="phone" onkeyup="validatePhone()"  placeholder="+959123456789"/>
                        ...
                        <div class="input-group">
                            ...
                            <form:input id="email" type="text" class="form-control" path="email" onkeyup="validateEmail()" placeholder="abc@gmail.com"/>
                        </div>
                        ...
                        <Br> 
                            <div class="input-group">
                                ...
                                <form:input id="address" type="text" class="form-control" path="address" maxlength="49" placeholder="Supervisor Address"/>
                            </div>
                            <br>
                            <center><button type="submit" class="btn btn-primary">CONFIRM </button>
                            <button type="cancel" value="cancel"  class="btn btn-primary"><a href="${pageContext.request.contextPath}/cancelSaveSupervisor">CANCEL</a></button>
                            </center>
                            </form:form>
                            </div>
                            </div>
