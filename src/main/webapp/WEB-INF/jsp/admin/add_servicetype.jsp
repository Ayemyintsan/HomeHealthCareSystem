...
<head>
  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.1/js/bootstrap.min.js"></script>
    ...
    <title>Add More Physician</title>
...
<body>
    <div class="wrapper">
        ...
        <div class="main_content">
            <div class="header">Add Service Types</div>
            <div class="info">
                <div>
                    <form:form action="saveServiceType" modelAttribute="servicetype" method="post">
                        ...
                        <div class="input-group">
                            ...
                            <form:input id="des" type="text" class="form-control" path="description" maxlength="110"  placeholder="Description"/>
                        </div>
                        <Br>
