                ...
                <div>
                    <form:form action="saveMessage" modelAttribute="message" method="post">
                        ...
                        <div class="input-group">
                            ...
                            <form:input id="name" type="text" class="form-control" path="name" maxlength="49" placeholder="Message"/>
                        </div>
                        <Br>
                            ...
                            <button type="cancel" value="cancel"  class="btn btn-primary"><a href="${pageContext.request.contextPath}/cancelSaveMessage">CANCEL</a></button>
                            </center>
                            </form:form>
                          </div>
                        </div>
