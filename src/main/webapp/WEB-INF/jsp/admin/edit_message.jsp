...
<body>
    <div class="wrapper">
        ...
        <div class="main_content">
            ...
            <div class="info">
                <div>
                    <form:form action="/HomeHealthCareSystem/editSaveMessage" modelAttribute="message" method="post">
                  
                        <div class="input-group">
                            <span class="input-group-addon"><i class="glyphicon glyphicon-folder-open"></i></span>
                            <form:input id="name" type="text" class="form-control" path="name" maxlength="110" placeholder="Message"/>
                        </div>
                        <Br>
