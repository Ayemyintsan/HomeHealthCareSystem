...
<body>
    <div class="wrapper">
        ...
        <div class="main_content">
            <div class="header">Service List
                <button><a href="addservice">Add More Services</a></button>
            </div>
            <div class="info">
                <div>
                           	...
                           	<%int index = 1;%>
								<c:forEach var="service" items="${serviceList}">
									<tr>
										...
										<td>${service.price}</td>
										<td>
											<a href="editService/${service.id}"class="settings" title="Edit">Edit</a>
											<a href="deleteService/${service.id}" class="delete" title="Delete" onclick = "return confirm('Are you sure to delete?')">Delete</a>
                    					</td>
									</tr>
								</c:forEach>
                        </tr>
