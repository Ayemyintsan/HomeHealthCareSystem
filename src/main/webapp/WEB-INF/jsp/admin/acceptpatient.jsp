    ...
    <body>
        <div class="wrapper">
            ...
            <div class="main_content">
                <div class="header">Patient Information Form</div>
                           	...
                           	<%int index = 1;%>
								<c:forEach var="patient" items="${patientList}">
									<tr>
										...
										<td>${patient.carename}</td>
										<td>${patient.price}</td>
										<td align="center"> 
											
											<a href="deleteAcceptPatient/${patient.patid}" class="delete" title="Delete" onclick="return confirm('Are you sure Delete?')">Delete</a>
                    					</td>
									</tr>
								</c:forEach> 
                        </tr>
