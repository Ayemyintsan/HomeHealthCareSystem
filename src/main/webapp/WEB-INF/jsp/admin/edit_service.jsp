...
<body>
    <div class="wrapper">
        ...
        <div class="main_content">
            ...
            <div class="info">
                <div>
                    <form:form action="/HomeHealthCareSystem/editSaveService" modelAttribute="service" method="post">
                   
                    	<div class="input-group">
                            <span class="input-group-addon"><i class="glyphicon glyphicon-th-list"></i></span>
                            <form:input id="id" type="text" class="form-control" path="id" hidden="true" disable="true 	"/>
                            </div>
                            <br>
                            ...
                            <div class="input-group">
                              <span class="input-group-addon"><i class="glyphicon glyphicon-folder-close"></i></span>                     
                                 	<form:select class="form-control" path="serviceTypeId" required="true">
                                 		<form:option value="${service.serviceTypeId}">${service.serviceTypename}</form:option>
                        ...
                        <div class="input-group">
                            ...
                            <form:input id="price" type="text" class="form-control" path="price" maxlength="7" placeholder="Price"/>
                        </div>
                        <Br>
                            ...
                            <button type="cancel" value="cancel"  class="btn btn-primary"><a href="${pageContext.request.contextPath}/cancelSaveServiceType">CANCEL</a></button>
                            </center>
                            </form:form>
                          </div>
                        </div>
