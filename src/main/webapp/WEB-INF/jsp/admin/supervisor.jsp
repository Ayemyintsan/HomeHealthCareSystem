...
<body>
    <div class="wrapper">
        ...
        <div class="main_content">
            <div class="header">Supervisors
                <button><a href="addsupervisor">Add More Supervisor</a></button>
            </div>
                    ...
                    <%int index = 1;%>
								<c:forEach var="supervisor" items="${supervisorList}">
									<tr>
										...
										<td align="center"> 
											<a href="editSupervisor/${supervisor.supid}"class="settings" title="Edit">Edit</a>
											<a href="deleteSupervisor/${supervisor.supid}" class="delete" title="Delete" onclick="return confirm('Are you sure Delete?')">Delete</a>
                    					</td>
									</tr>
								</c:forEach>
                </tr>
