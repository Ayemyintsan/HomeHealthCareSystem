...
<body>
    <div class="wrapper">
        ...
        <div class="main_content">
            <div class="header">Update Physicians</div>
            <div class="info">
                <div>
                    <form:form action="/HomeHealthCareSystem/editSaveDepartment" modelAttribute="department" method="post">
                   
                    	<div class="input-group">
                            <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                            <form:input id="id" type="text" class="form-control" path="id" hidden="true"/>
                            </div>
                            <br>
                        
                        <div class="input-group">
                            <span class="input-group-addon"><i class="glyphicon glyphicon-folder-open"></i></span>
                            <form:input id="deptname" type="text" class="form-control" path="deptname" placeholder="Physician Name"/>
                        </div>
                        <Br>
