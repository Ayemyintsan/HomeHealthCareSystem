<%@page import="com.java.bean.Patient"%>
...
<head>
    ...
    <body>
        ...
        <div class="wrapper">
            <div class="sidebar">
                ...
                <li><a href="allcaregiverList" onclick="return confirm('Are you sure to logout?')"><i class="fa fa-user-nurse" aria-hidden="true"></i>Caregiver</a></li>
                
                <li><a href="showLoginForm"><i class="fa fa-reply" aria-hidden="true"></i>Log Out</a></li>
                </ul>
            </div>
            <div class="main_content">
                <div class="header">Patient Request Form</div>
                           	...
                           	<%int index = 1;%>
								<c:forEach var="patient" items="${patientList}">
									<tr>
										...
										<td>${patient.messagename}</td>
										
										<td>
											<a href="editPatient/${patient.patid}"class="settings" title="Edit">Manage</a>
											<a href="deletePatient/${patient.patid}" class="delete" title="Delete" onclick="return confirm('Are you sure Delete?')">Delete</a>
                    					</td>
									</tr>
								</c:forEach>
                        </tr>
 ...
 <script src="<%=common.url%>/js/select2.min.js"></script>  
</body>
<script>
