    ...
    <div class="wrapper">
        ...
        <div class="main_content">
            <div class="header">Message
                <button><a href="addmessage">Add More Message</a></button>
            </div>
                    ...
                    <%int index = 1;%>
								<c:forEach var="message" items="${messageList}">
									<tr>
										...
										<td> 
											<a href="editMessage/${message.id}"class="settings" title="Edit">Edit</a>
											<a href="deleteMessage/${message.id}" class="delete" title="Delete" onclick="return confirm('Are you sure Delete?')">Delete</a>
                    					</td>
                </tr>
                </c:forEach>
            </tbody>
