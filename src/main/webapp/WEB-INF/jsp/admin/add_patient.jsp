...
<body>
    <div class="wrapper">
        ...
        <div class="main_content">
            <div class="header">Add More Patient</div>
            <div class="info">
                <div>
                    <form:form action="savePatient" modelAttribute="patient" method="post">
                        ...
                        <div class="input-group">
                            ...
                            <form:input id="name" type="text" class="form-control" path="name" placeholder="Patient Name"/>
                        </div>
                        <Br>
                        
                        <div class="input-group">
                            <span class="input-group-addon"><i class="glyphicon glyphicon-heart"></i></span>
                            <form:input id="age" type="text" class="form-control" path="age" placeholder="Age"/>
                        </div>
                        <Br>
                        
                        <div class="input-group">
                            <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                            <form:input id="physician" type="text" class="form-control" path="physician" placeholder="Physician "/>
                        </div>
                        <Br>

                        <div class="input-group">
                            <span class="input-group-addon"><i class="glyphicon glyphicon-grain"></i></span>
                            <form:input id="dob" type="text" class="form-control" path="dob"  placeholder="Date of Birth"/>
                        </div>
                        <Br>
                        
                        <div class="input-group">
                            <span class="input-group-addon"><i class="glyphicon glyphicon-grain"></i></span>
                            <form:input id="gender" type="text" class="form-control" path="gender"  placeholder="Gender"/>
                        </div>
                        <Br>

                        <div class="input-group">
                            <span class="input-group-addon"><i class="glyphicon glyphicon-earphone"></i></span>
                            <form:input id="phone" type="text" class="form-control" path="phone"  placeholder="Phone"/>
                        </div>
                        <Br>

                        <div class="input-group">
                            <span class="input-group-addon"><i class="glyphicon glyphicon-envelope"></i></span>
                            <form:input id="email" type="text" class="form-control" path="email"  placeholder="EmailAddress"/>
                        </div>
                        <Br>   

                        <div class="input-group">
                            <span class="input-group-addon"><i class="glyphicon glyphicon-usd"></i></span>
                            <form:input id="rgdate" type="date" class="form-control" path="registerdate"  placeholder="Register Date"/>
                        </div>
                        <Br> 
                            <div class="input-group">
                                <span class="input-group-addon"><i class="glyphicon glyphicon-tree-deciduous"></i></span>
                                <form:input id="address" type="text" class="form-control" path="address"  placeholder="Caregiver Address"/>
                            </div>
                            <div class="input-group">
                                <span class="input-group-addon"><i class="glyphicon glyphicon-tree-deciduous"></i></span>
                                <form:input id="servicepackage" type="text" class="form-control" path="servicepackage"  placeholder="ServicePackage"/>
                            </div>
                            <br>
                            <center><button type="submit" class="btn btn-primary ">CONFIRM </button>
                            <button type="cancel" value="cancel"  class="btn btn-primary"><a href="${pageContext.request.contextPath}/cancelSavePatient">CALCEL</a></button>
                            </center>
                            </form:form>
                            </div>
                            </div>
