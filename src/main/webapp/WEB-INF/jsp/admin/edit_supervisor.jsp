...
<body>
    <div class="wrapper">
        ...
        <div class="main_content">
            <div class="header">Update Supervisors</div>
            <div class="info">
                <div>
                    <form:form action="/HomeHealthCareSystem/editSaveSupervisor" modelAttribute="supervisor" method="post">
                   
                    	<div class="input-group">
                            <span class="input-group-addon"><i class="glyphicon glyphicon-list-alt"></i></span>
                            <form:input id="id" type="text" class="form-control" path="supid" hidden="true" />
                            </div>
                            <br>
                        
                        <div class="input-group">
                            <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                            <form:input id="name" type="text" class="form-control" path="name" maxlength="49" placeholder="Supervisor Name"/>
                        </div>
                        <Br>
