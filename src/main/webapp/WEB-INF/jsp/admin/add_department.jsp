...
<body>
    <div class="wrapper">
        ...
        <div class="main_content">
            <div class="header">Add More Department</div>
            <div class="info">
                <div>
                    <form:form action="saveDepartment" modelAttribute="department" method="post">
                        ...
                        <div class="input-group">
                            ...
                            <form:input id="deptname" type="text" class="form-control" path="deptname" placeholder="Department Name"/>
                        </div>
                        <Br>

                        <div class="input-group">
                            <span class="input-group-addon"><i class="glyphicon glyphicon-grain"></i></span>
                            <form:input id="description" type="text" class="form-control" path="description"  placeholder="Description"/>
                        </div>
                        <Br>
                            ...
                            <button type="cancel" value="cancel"  class="btn btn-primary btn-block"><a href="${pageContext.request.contextPath}/cancelSaveDepartment">CALCEL</a></button>
                            </form:form>
                          </div>
                        </div>
                      </div>
