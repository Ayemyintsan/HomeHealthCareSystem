...
<body>
    <div class="wrapper">
        ...
        <div class="main_content">
            <div class="header">Add More Services</div>
            <div class="info">
                <div>
                       ...
                       <div class="input-group">
                          ...
                          <div class="input-group">
                              <span class="input-group-addon"><i class="glyphicon glyphicon-list-alt"></i></span>
                               <form:input id="desc" type="text" class="form-control" path="description" maxlength="110" placeholder="Service Dsecription"/>
                          </div>
                          <Br>
  
                          <div class="input-group">
                              <span class="input-group-addon"><i class="glyphicon glyphicon-usd"></i></span>
                              <form:input id="cost" type="text" class="form-control" path="price" maxlength="7" placeholder="Price"/>
                          </div>
                          <Br>
                          <center>
                            <button type="submit" class="btn btn-primary">CONFIRM </button>
                            <button type="cancel" value="cancel" class="btn btn-primary"><a href="${pageContext.request.contextPath}/cancelSaveService">CANCEL</a></button>
                        </center>
                        </form:form>
                    </div>
                </div>
