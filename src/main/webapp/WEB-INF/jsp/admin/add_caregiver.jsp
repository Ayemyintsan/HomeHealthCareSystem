...
<body>
    <div class="wrapper">
        ...
        <div class="main_content">
            <div class="header">Add More Caregiver</div>
            <div class="info">
                <div>
                    <form:form action="saveCaregiver" modelAttribute="caregiver" method="post">
                       

                        <div class="input-group">
                            <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                            <form:input id="name" type="text" class="form-control" path="name" pattern="^[A-Za-z\s]+$" maxlength="20" placeholder="Caregiver Name"/>
                        </div>
                        <Br>
                        ...
                        <div class="input-group">
                            ...
                            <form:input id="phone" type="text" class="form-control" path="phone" onkeyup="validatePhone()" placeholder="+959767303582"/>
                       ...
                       <Br>
                        ...
                        <div class="input-group">
                            ...
                            <form:input id="email" type="text" class="form-control" path="email" onkeyup="validateEmail()" placeholder="aaa@gmail.com"/>
                        ...
                        <div class="input-group">
                            ...
                            <form:input id="salary" type="text" class="form-control" path="salary" pattern="^[0-9\s]+$" maxlength="7" placeholder="Salary"/>
                        </div>
                        <Br> 
                            <div class="input-group">
                           ...
                           <center> <button type="submit" class="btn btn-primary">CONFIRM </button>
                            ...
                            <button type="cancel" value="cancel"  class="btn btn-primary"><a href="${pageContext.request.contextPath}/cancelSaveCaregiver">CANCEL</a></button>
                            </center>
                            </form:form>
                            </div>
                            </div>
