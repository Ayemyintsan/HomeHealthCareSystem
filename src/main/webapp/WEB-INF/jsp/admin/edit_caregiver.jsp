...
<body>
    <div class="wrapper">
        ...
        <div class="main_content">
            <div class="header">Update Caregiver</div>
            <div class="info">
                <div>
                    <form:form action="/HomeHealthCareSystem/editSaveCaregiver" modelAttribute="caregiver" method="post">
                       
                       <div class="input-group">
                            <span class="input-group-addon"><i class="glyphicon glyphicon-th-list"></i></span>
                            <form:input id="careid" type="text" class="form-control" path="careid" hidden="true"/>
                            </div>
                            <br>

                        <div class="input-group">
                            <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                            <form:input id="name" type="text" class="form-control" path="name" maxlength="49" placeholder="Caregiver Name"/>
                        </div>
                        <Br>
                        
                        <div class="input-group">
                              <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>                     
                                 	<form:select class="form-control" path="supervisorId" required="true">
                                 		<form:option value="${caregiver.supervisorId}">${caregiver.supervisorName}</form:option>
										<c:forEach var="supervisor" items="${supervisorList}">
											<form:option value="${supervisor.supid}">${supervisor.name}</form:option>
										</c:forEach>
									</form:select>                                    
                          </div>
                          <Br>
                        ...
                        <div class="input-group">
                            ...
                            <form:input id="salary" type="text" class="form-control" path="salary" maxlength="7"  placeholder="Salary"/>
                        </div>
                        <Br> 
                            <div class="input-group">
                                <span class="input-group-addon"><i class="glyphicon glyphicon-cloud-upload"></i></span>
                                <form:input id="address" type="text" class="form-control" path="address" maxlength="49"  placeholder="Caregiver Address"/>
                            </div>
                            <br>
                            <center><button type="submit" class="btn btn-primary ">CONFIRM </button>
                            <button type="cancel" value="cancel"  class="btn btn-primary "><a href="${pageContext.request.contextPath}/cancelSaveCaregiver">CALCEL</a></button>
                            </center>
                            </form:form>
                            </div>
                            </div>
