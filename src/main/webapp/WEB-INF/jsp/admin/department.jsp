    ...
    <div class="wrapper">
        ...
        <div class="main_content">
            <div class="header">Department
                <button><a href="adddepartment">Add More Department</a></button>
            </div>
            <div class="info">
                <div>
                           	...
                           	<%int index = 1;%>
								<c:forEach var="department" items="${departmentList}">
									<tr align="center">
										...
										<td align="center"> 
											<a href="editDepartment/${department.id}"class="settings" title="Edit">Edit</a>
											<a href="deleteDepartment/${department.id}" class="delete" title="Delete">Delete</a>
                    					</td>
									</tr>
								</c:forEach>
                        </tr>
